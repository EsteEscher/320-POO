...
namespace Drones
{
    ...
    {
        private int _charge;                            // La _charge actuelle de la batterie
        ...
        public Drone(int x, int y, string name)
        {
            this._x = x;
            this._y = y;
            this._targetX = RandomHelpers.GeneratingFlyFluc(Config.AIRSPACE_WIDTH);
            this._targetY = RandomHelpers.GeneratingFlyFluc(Config.AIRSPACE_HEIGHT);
            this._name = name;
        ...
        public void Update(int interval)
        {
            ...
            _y += (int)(deltaY / distance * step);    // Il s'est déplacé d'une valeur aléatoire vers le haut ou le bas
